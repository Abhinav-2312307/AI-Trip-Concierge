      ...
      >
        ...
        <div style={{ position: 'relative', height: '240px', background: '#0B1626' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.82rem', color: '#FDBA74', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '4px', marginBottom: '4px' }}>
        ...
        <div style={{ padding: '24px 28px' }}>
          ...
          <div style={{
            ...
            <div>
              <span style={{ fontSize: '0.74rem', color: '#64748B', textTransform: 'uppercase', fontWeight: 600, display: 'block', marginBottom: '2px' }}>
                Check-in & Check-out
              </span>
              <div style={{ fontSize: '0.9rem', fontWeight: 700, color: '#101F35', display: 'flex', alignItems: 'center', gap: '6px' }}>
                <Calendar size={14} color="#D05B3B" />
            ...
            <div>
              ...
              <span style={{ fontSize: '0.75rem', color: '#D05B3B', fontWeight: 600, marginTop: '2px', display: 'block' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            <h4 style={{ fontSize: '0.86rem', fontWeight: 700, color: '#101F35', marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '0.03em' }}>
              Property Address
            </h4>
          ...
          {hotel.highlights && hotel.highlights.length > 0 && (
            <div style={{ marginBottom: '20px' }}>
              <h4 style={{ fontSize: '0.86rem', fontWeight: 700, color: '#101F35', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.03em' }}>
                Resort Highlights & Experiences
              </h4>
              <ul style={{ margin: 0, paddingLeft: '18px', display: 'flex', flexDirection: 'column', gap: '4px', fontSize: '0.88rem', color: '#334155' }}>
                ...
                {hotel.amenities.map((amenity, idx) => (
                  <span
                    ...
                    style={{
                      ...
                      color: '#1E3A63',
                      border: '1px solid rgba(23, 45, 77, 0.1)',
                      fontSize: '0.78rem',
                      fontWeight: 600,
                      padding: '4px 10px',
                      borderRadius: 'var(--radius-xs)'
          ...
          <div style={{
            ...
            >
              <Sparkles size={14} color="#D05B3B" /> Plan My Trip
            </button>
